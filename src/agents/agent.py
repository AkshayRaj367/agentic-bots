...
class Agent:
    ...
    def make_decision(self, prompt: str, project_name: str) -> str:
        ...
        for item in decision:
            ...
            self.project_manager.add_message_from_imposter(project_name, reply)
    ...
    def execute(self, prompt: str, project_name: str) -> str:
        ...
        self.project_manager.add_message_from_imposter(project_name, reply)
        self.project_manager.add_message_from_imposter(project_name, json.dumps(plans, indent=4))
        # self.project_manager.add_message_from_imposter(project_name, f"In summary: {summary}")
